 ...
 */
final class Version20221006105334 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE allocation DROP id, CHANGE id_alloc id_alloc INT AUTO_INCREMENT NOT NULL, ADD PRIMARY KEY (id_alloc)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE allocation MODIFY id_alloc INT NOT NULL');
        $this->addSql('ALTER TABLE allocation DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE allocation ADD id INT NOT NULL, CHANGE id_alloc id_alloc INT NOT NULL');
